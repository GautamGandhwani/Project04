			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>First Name :</b></label> <input
						...
						placeholder="Enter First Name">&nbsp; <label><b>Role
								:</b></label> <%=HTMLUtility.getList("roleId", DataUtility.getStringData(bean.getRoleId()), roleList)%>&nbsp;
			...
			<table style="width: 100%">
				<tr>
					...
					<td style="text-align: right;"><input type="submit"
						name="operation" val ue="<%=UserListCtl.OP_NEXT%>"
